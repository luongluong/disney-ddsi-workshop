...
1. Go to the **☰** hamburger menu from the top left and select **Build**.
    <img width="374" height="251" alt="image" src="https://github.com/user-attachments/assets/6525d555-94b7-4a7b-a8dc-39f8536d1840" />

2. On the Agent Builder page, click **Create agent +**.
    <img width="468" height="199" alt="image" src="https://github.com/user-attachments/assets/9d385a92-8a09-4cb6-9a54-65df860448ec" />

3. Select the **Create from scratch** option.
    <img width="468" height="287" alt="image" src="https://github.com/user-attachments/assets/3030caf4-c1da-4118-bb1d-7ef96297eb66" />
...
4. Enter the following details:
   ...
   Click **Create**.
   <img width="468" height="275" alt="image" src="https://github.com/user-attachments/assets/9a7748fb-2650-4793-ac79-bde83d91ae93" />
